...
public class WoollyGigantelopeEntitySpawn {
    ...
    public static void addWoollyGigantelopeEntitySpawn(){
        BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.SNOWY_PLAINS, BiomeKeys.SNOWY_TAIGA), SpawnGroup.CREATURE, ModEntities.WOOLLYGIGANTELOPE, 50, 3,6);
